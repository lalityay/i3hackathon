...
- In a terminal, navigate to `SPG.i3Hackathon.QnaBot`

    ```bash
    # change into project folder
    cd SPG.i3Hackathon.QnaBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `SPG.i3Hackathon.QnaBot` folder
  - Select `SPG.i3Hackathon.QnaBot.csproj` file
